  ...
  return (
    <div>
      <div className="flex w-full">
        <div className="w-[80%] h-[60px] bg-slate-800 flex justify-start shadow-2xl">
      ...
      <div>
        <div className="min-h-[580px] bg-gradient-to-r from-blue-500 to-red-400 flex-col overflow-y-auto p-5">
